...
class VeritasAgent:
    ...
    async def invoke(self, message: str, user_id: str = None, server_id: str = None):
        """Process a message and return the agent's text response"""
        try:
            
            # Create a session
            #TODO: Create actual session storage instead of create session. Not good for production
